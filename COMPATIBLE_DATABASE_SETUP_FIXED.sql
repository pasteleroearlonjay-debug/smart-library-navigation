-- ========================================
-- COMPATIBLE DATABASE SETUP FOR EXISTING SCHEMA (FIXED VERSION)
...
-- STEP 10: Insert sample borrowing records using actual member IDs
DO $$
DECLARE
    john_id BIGINT;
    jane_id BIGINT;
...
BEGIN
    ...
    IF john_id IS NOT NULL THEN
        ...
        (john_id, 'Algebra Fundamentals', '2024-01-10', '2024-01-24', 'borrowed'),
        (john_id, 'Physics Principles', '2024-01-12', '2024-01-26', 'borrowed')
        ON CONFLICT DO NOTHING;
    END IF;
    
    IF jane_id IS NOT NULL THEN
        INSERT INTO borrowing_records (member_id, book_title, borrowed_date, due_date, status) VALUES
        (jane_id, 'World History', '2023-12-01', '2023-12-15', 'overdue'),
        (jane_id, 'Chemistry Basics', '2024-01-05', '2024-01-19', 'borrowed')
        ON CONFLICT DO NOTHING;
    END IF;
    
    IF sarah_id IS NOT NULL THEN
        INSERT INTO borrowing_records (member_id, book_title, borrowed_date, due_date, status) VALUES
        (sarah_id, 'Computer Programming', '2024-01-08', '2024-01-22', 'borrowed'),
        (sarah_id, 'Music Appreciation', '2024-01-09', '2024-01-23', 'borrowed'),
        (sarah_id, 'Character Building', '2024-01-11', '2024-01-25', 'borrowed')
        ON CONFLICT DO NOTHING;
    END IF;
END $$;
...
-- STEP 12: Insert sample book requests using actual member IDs
DO $$
DECLARE
    john_id BIGINT;
    jane_id BIGINT;
...
-- STEP 13: Insert sample notifications using actual member IDs
DO $$
DECLARE
    john_id BIGINT;
    jane_id BIGINT;
