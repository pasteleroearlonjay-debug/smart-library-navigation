-- ========================================
-- COMPATIBLE DATABASE SETUP FOR EXISTING SCHEMA
...
-- STEP 2: Fix borrowing_records table to work with library_members
-- First, let's see what columns exist and add the missing one
ALTER TABLE borrowing_records ADD COLUMN IF NOT EXISTS member_id BIGINT REFERENCES library_members(id) ON DELETE CASCADE;
ALTER TABLE borrowing_records ADD COLUMN IF NOT EXISTS book_title VARCHAR(255);

-- Update existing records to use member_id instead of user_id if needed
...
INSERT INTO library_members (name, email, password_hash, join_date, borrowed_count, overdue_count, status, membership_id, email_verified) VALUES
('John Doe', 'john.doe@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2023-01-15', 2, 0, 'Active', 'LIB001', true),
('Jane Smith', 'jane.smith@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2023-02-20', 1, 1, 'Active', 'LIB002', true),
('Mike Johnson', 'mike.johnson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2023-03-10', 0, 0, 'Active', 'LIB003', true),
('Sarah Wilson', 'sarah.wilson@email.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2023-04-05', 3, 0, 'Suspended', 'LIB004', true)
...
-- STEP 10: Insert sample borrowing records using member_id
...
-- STEP 11: Update existing members with verification status and last login
...
-- STEP 12: Insert sample book requests
...
-- STEP 13: Insert sample notifications
...
-- STEP 15: Create notification functions
